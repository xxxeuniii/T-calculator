  ...
  const [history, setHistory] = useState([
    {
      ...
      detail: [
        { label: "成本价", value: "60,000.00 USDT" },
        { label: "激活价", value: "68,000.00 USDT" },
        { label: "回调率", value: "0.1%" },
        { label: "数量", value: "300 USDT" }
      ],
      time: "06/22 14:48",
    },
    {
      ...
      detail: [
        { label: "成本价", value: "42,000.00 USDT" },
        { label: "激活价", value: "38,000.00 USDT" },
        { label: "回调率", value: "0.3%" },
        { label: "数量", value: "500 USDT" }
      ],
      time: "06/22 14:35",
    },
    {
      ...
      summary: "净收益：¥214.40",
      detail: [
        { label: "卖出价", value: "29.30" },
        { label: "接回价", value: "28.80" },
        { label: "股数", value: "500" }
      ],
      time: "06/22 10:22",
    },
    {
      ...
      summary: "净收益：¥156.85",
      detail: [
        { label: "买入价", value: "33.50" },
        { label: "卖出价", value: "34.10" },
        { label: "股数", value: "300" }
      ],
      time: "06/21 15:45",
    },
    {
      ...
      detail: [
        { label: "成本价", value: "58,000.00 USDT" },
        { label: "激活价", value: "62,000.00 USDT" },
        { label: "回调率", value: "0.5%" },
        { label: "数量", value: "200 USDT" }
      ],
      time: "06/21 09:30",
    },
  ]);
